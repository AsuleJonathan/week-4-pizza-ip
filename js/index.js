...
function pizzasize(){
    if(valueTaker==500){
        ...
        alert(`Your Pizza will be delivered at ${location} and the delivery charges are ${deliveryCharge} . The total cost is ${totalCost} . Your pizza will be delivered at ${location}`);
        amount = 0;
        selectedSize = null;
        selectedSize = null;
    }else if(valueTaker==700){
